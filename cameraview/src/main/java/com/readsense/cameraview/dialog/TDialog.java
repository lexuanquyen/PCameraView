package com.readsense.cameraview.dialog;
...
public class TDialog extends BaseDialogFragment {
    ...
    public static class Builder {
         ...
         * @return
         */
        public TDialog.Builder setDialogView(View view) {
         ...
         * 设置弹窗宽度是屏幕宽度的比例 0 -1
         */
        public TDialog.Builder setScreenWidthAspect(Context context, float widthAspect) {
         ...
         * 设置弹窗高度是屏幕高度的比例 0 -1
         */
        public TDialog.Builder setScreenHeightAspect(Context context, float heightAspect) {
         ...
         * @return
         */
        public TDialog.Builder setCancelableOutside(boolean cancel) {
         ...
         * @return
         */
        public TDialog.Builder setOnDismissListener(DialogInterface.OnDismissListener dismissListener) {
         ...
         * @return
         */
        public TDialog.Builder addOnClickListener(int... ids) {
            params.ids = ids;
            return this;
        }
         ...
         * @return
         */
        public TDialog.Builder setOnViewClickListener(OnViewClickListener listener) {
         ...
         * @return
         */
        public TDialog.Builder setDialogAnimationRes(int animationRes) {
         ...
         * 监听弹窗后，返回键点击事件
         */
        public TDialog.Builder setOnKeyListener(DialogInterface.OnKeyListener keyListener) {
